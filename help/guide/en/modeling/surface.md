...
order: 308
---
In the section [Modeling with Topology Primitives](/guide/modeling/topology/) we saw that you can easily create curved surfaces with Archiyou. In the future we intend to make this even easier to design beautiful curved shapes.
