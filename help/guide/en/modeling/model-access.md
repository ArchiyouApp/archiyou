---
title: "Access parts of your model"
order: 303
---
...
There is a huge variety of 3D shapes but in essence all consist of *Vertices*, *Edges*, *Wires*, *Faces*, *Shells* and *Solids*. And even better; an Edge is nothing more than a linear Shape between two Vertices. A Wire a sequence of Edges, a Face the surface bound by a closed Wire and so on. See more on these *Topology* entities in section [Modeling with Topology primitives](/guide/modeling/topology/).
