---
title: "Modeling with topology primitives"
order: 305
---
...
:::caution
If this section is a bit too theoretic for you. Just skip ahead to [Constructive Solid Geometry Modeling](/guide/modeling/csg/) which is more hands-on. You can always learn about topology primitives later! ☕
:::
...
Faces in a BREP system can be non-planar (unlike in mesh modeling). This is actually a very powerful feature that we can use in [Advanced Surface Modeling](/guide/modeling/surface/).
...
See [Access parts of your model](/guide/modeling/model-org/) for more information on subshapes and selectors.
...
Let's quickly move on to [Constructive Solid Geometry modeling](/guide/modeling/csg/) which is a bit simpler.
