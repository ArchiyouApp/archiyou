---
title: "Archiyou Scripting Language"
order: 3
---
...
We feel that basic Javascript knowledge is enough to start modeling with Javascript. So if you want to start immediately [just jump in](/guide/modeling/).
...
Continue to learn about the basic of the [Archiyou scripting language](/guide/introduction/language-basics/)
