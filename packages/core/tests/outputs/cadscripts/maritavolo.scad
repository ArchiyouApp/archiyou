...
// Skipped: diagLine (open curve), Curve:Line (open curve)
...
module sideD() {
    color([1, 0, 0]) multmatrix([[0.496138938357, 0.868243142124, 0, 50.0743379767], [0, 0, 1, 0], [0.868243142124, -0.496138938357, 0, 302.72548556], [0, 0, 0, 1]]) linear_extrude(height = 25) polygon([[0, 0], [457.561361749, 0], [479.965042556, 44.69983318], [22.4036808065, 44.69983318]]);
}

// sideD  (layer diagonalLeft)
module sideD_2() {
    color([1, 0, 0]) multmatrix([[-0.496138938357, -0.868243142124, 0, 749.925662023], [0, 0, 1, 0], [0.868243142124, -0.496138938357, 0, 302.72548556], [0, 0, 0, 1]]) linear_extrude(height = 25) polygon([[0, 0], [457.561361749, 0], [479.965042556, 44.69983318], [22.4036808065, 44.69983318]]);
}
...
// sideD  (layer diagonalLeft)
module sideD_3() {
    color([1, 0, 0]) multmatrix([[0.496138938357, 0.868243142124, 0, 50.0743379767], [0, 0, 1, 1325], [0.868243142124, -0.496138938357, 0, 302.72548556], [0, 0, 0, 1]]) linear_extrude(height = 25) polygon([[0, 0], [457.561361749, 0], [479.965042556, 44.69983318], [22.4036808065, 44.69983318]]);
}

// sideD  (layer diagonalLeft)
module sideD_4() {
    color([1, 0, 0]) multmatrix([[-0.496138938357, -0.868243142124, 0, 749.925662023], [0, 0, 1, 1325], [0.868243142124, -0.496138938357, 0, 302.72548556], [0, 0, 0, 1]]) linear_extrude(height = 25) polygon([[0, 0], [457.561361749, 0], [479.965042556, 44.69983318], [22.4036808065, 44.69983318]]);
}
