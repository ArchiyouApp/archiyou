...
module Mesh() {
    color([0, 0, 1]) polyhedron(
        points = [[564.644660941, -25, 685.355339059], [-85.3553390593, -25, 35.3553390593], [-85.3553390593, 0, 35.3553390593], [564.644660941, 0, 685.355339059], [-50, -25, 0], [600, -25, 650], [600, 0, 650], [-50, 0, 0]],
        faces = [[0, 1, 2, 3], [4, 5, 6, 7], [4, 1, 0, 5], [5, 0, 3, 6], [2, 7, 6, 3], [4, 7, 2, 1]]
    );
}
...
module beamDiagonal() {
    color([1, 0, 0]) polyhedron(
        points = [[-50, 0, 0], [600, 0, 650], [564.644660941, 0, 685.355339059], [-85.3553390593, 0, 35.3553390593], [-85.3553390593, -25, 35.3553390593], [-50, -25, 0], [600, -25, 650], [564.644660941, -25, 685.355339059]],
        faces = [[0, 1, 2, 3], [0, 3, 4, 5], [1, 0, 5, 6], [4, 3, 2, 7], [1, 6, 7, 2], [5, 4, 7, 6]]
    );
}
...
module beamDiagonal_2() {
    color([1, 0, 0]) polyhedron(
        points = [[-85.3553390593, 525, 35.3553390593], [-85.3553390593, 500, 35.3553390593], [-50, 500, 0], [-50, 525, 0], [564.644660941, 500, 685.355339059], [600, 500, 650], [600, 525, 650], [564.644660941, 525, 685.355339059]],
        faces = [[0, 1, 2, 3], [1, 4, 5, 2], [6, 7, 0, 3], [5, 4, 7, 6], [1, 0, 7, 4], [3, 2, 5, 6]]
    );
}
...
module Mesh_12() {
    color([1, 0, 0]) polyhedron(
        points = [[-25, 450, 250], [-25, 450, 50], [0, 450, 50], [0, 450, 250], [0, 500, 50], [0, 500, 250], [-25, 500, 50], [-25, 500, 250]],
        faces = [[3, 2, 1, 0], [2, 3, 5, 4], [2, 4, 6, 1], [7, 5, 3, 0], [6, 7, 0, 1], [7, 6, 4, 5]]
    );
}
