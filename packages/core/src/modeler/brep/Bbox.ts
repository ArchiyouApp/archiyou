...
import type { AnyShape, PointLike, MainAxis, Side } from './types' // types
import { Brep, Point, Vector, Shape, Vertex, Edge, 
        Face, Solid, AnyShapeOrCollection } from '.'

//import { targetOcForGarbageCollection } from './internal'  // TODO AFTER REFACTOR
