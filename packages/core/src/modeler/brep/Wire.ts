...
import { WIRE_RECT_WIDTH, WIRE_RECT_DEPTH, WIRE_RECT_POSITION, WIRE_POPULATE_NUM, WIRE_COMBINE_RADIUS, WIRE_LOFTED_SOLID, 
    ...
    WIRE_OFFSET_TYPE, WIRE_FILLET_RADIUS, WIRE_CHAMFER_DISTANCE, WIRE_CHAMFER_ANGLE } from '.'
...
import type { PointLike, Cursor, AnyShape, AnyShapeOrCollection,
        ...
        DimensionOptions } from '.'

// typeguards
import { isCoordArray } from '.'
...
import { flattenEntitiesToArray, toRad } from '.' // utils
