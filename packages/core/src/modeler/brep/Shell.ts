...
import type { MakeShellInput, ThickenDirection, 
            AnyShapeOrCollection, AnyShapeSequence } from '.' // types

import { isCoordArray, isLinearShape } from '.' // typeguards

import { Vector, Point, Shape, Vertex, Edge, Wire, Face, Solid, ShapeCollection } from '.'

import { targetOcForGarbageCollection, removeOcTargetForGarbageCollection } from '.';


import { flattenEntities } from '.' // utils
