...
import { SOLID_MAKEBOX_SIZE, SOLID_MAKESPHERE_RADIUS, SOLID_MAKESPHERE_ANGLE, SOLID_MAKECONE_BOTTOM_RADIUS, SOLID_MAKECONE_TOP_RADIUS,
    ...
    SOLID_THICKEN_AMOUNT, SOLID_THICKEN_DIRECTION } from '.'
...
import { isMakeSolidInput, isSelectionString } from '.'; // typeguards
import { Vector, Point, Shape, Vertex, Edge, Wire, Face, Shell, ShapeCollection } from '.'
